...
state keys:
	...
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:25242f63-0b14-49d4-83b7-be2abd557a75}
	...
	{Secret/tracey/sleevecdc-superuser:495dbf33-22b3-4af8-9257-d43c2bbc6966}
	...
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:9e057ae8-8af8-4d75-9881-b6e945a909cf}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:a128ffa6-42a7-4f50-9203-b6b8cf183fa8}
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:25242f63-0b14-49d4-83b7-be2abd557a75}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
  "metadata": {
    ...
    "name": "sleevecdc-sample-dc-sample-rack-sts-1",
    "namespace": "tracey",
    "ownerReferences": [
      {
        "apiVersion": "apps/v1",
    ...
    "volumes": [
      ...
      },
      {
        ...
        "persistentVolumeClaim": {
          "claimName": "server-data-sleevecdc-sample-dc-sample-rack-sts-1"
        }
      }
    ]
  },
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:9e057ae8-8af8-4d75-9881-b6e945a909cf}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
  "metadata": {
    ...
    "name": "sleevecdc-sample-dc-sample-rack-sts-0",
    "namespace": "tracey",
    "ownerReferences": [
      {
        "apiVersion": "apps/v1",
  ...
  "spec": {
    ...
    "volumes": [
      ...
      },
      {
        "name": "server-data",
        "persistentVolumeClaim": {
          "claimName": "server-data-sleevecdc-sample-dc-sample-rack-sts-0"
        }
      }
    ]
  },
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:a128ffa6-42a7-4f50-9203-b6b8cf183fa8}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
  "metadata": {
    ...
    "name": "sleevecdc-sample-dc-sample-rack-sts-2",
    "namespace": "tracey",
    "ownerReferences": [
      {
        "apiVersion": "apps/v1",
  ...
  "spec": {
    ...
    "volumes": [
      ...
      },
      {
        "name": "server-data",
        "persistentVolumeClaim": {
          "claimName": "server-data-sleevecdc-sample-dc-sample-rack-sts-2"
        }
      }
    ]
  },
...
```
Key: {Secret/tracey/sleevecdc-superuser:495dbf33-22b3-4af8-9257-d43c2bbc6966}
```
{
  "apiVersion": "v1",
  "data": {
    "password": "ZkstcGRBaEg5cWM2VVV2cXVQT0RuMDNvbjRQOUdBVFg0TmFwNGZWMVlqOGVtMkIxRXJwdXpR",
    "username": "c2xlZXZlY2RjLXN1cGVydXNlcg=="
  },
  "kind": "Secret",
  "metadata": {
    "creationTimestamp": null,
...
Path 1:
```
	CassandraDatacenter:5328cd3e (explore) - #changes=1
	...
	StatefulSetController:e54bb03c (explore) - #changes=3
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 62a568f9-bc96-4ad1-a78a-fdebee25bafe
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 63d2d589-61fe-4b8d-a05f-efadc6c6817f
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: fe97c67a-7681-4431-8e00-d7531503d335

	CleanupReconciler:6cda56f6 (explore) - #changes=1
	...
	StatefulSetController:73efec37 (explore) - #changes=2
	DELETE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}
	...
	CleanupReconciler:944b045b (explore) - #changes=1
	REMOVE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:2d631b0f-7b2f-43a2-b547-9ebc070a5fc9}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:2d631b0f-7b2f-43a2-b547-9ebc070a5fc9}: 
	StatefulSetController:4d928a10 (explore) - #changes=1
	DELETE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}: 
	CleanupReconciler:482ccf67 (explore) - #changes=1
	REMOVE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}: 
	StatefulSetController:77870b10 (explore) - #changes=1
	...
	CassandraDatacenter:407be63d (explore) - #changes=4
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 52c05ab8-268b-458a-bf64-0cabcc27e401
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 909b6748-ed85-438b-a56f-5909e096891e
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: c937800d-7f07-4652-b589-266399769f3f
...
{*unstructured.Unstructured}.Object["status"].(map[string]any)["superUserUpserted"]:
	...
	CassandraDatacenter:d12722eb (explore) - #changes=2
	CREATE: {Secret/tracey/sleevecdc-superuser:495dbf33-22b3-4af8-9257-d43c2bbc6966}
	PATCH: {StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}
	{StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}: {*unstructured.Unstructured}.Object["spec"].(map[string]any)["replicas"].(float64):
	-: 0
	+: 3

	StatefulSetController:fb60918d (explore) - #changes=3
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:9e057ae8-8af8-4d75-9881-b6e945a909cf}
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:25242f63-0b14-49d4-83b7-be2abd557a75}
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:a128ffa6-42a7-4f50-9203-b6b8cf183fa8}
	StatefulSetController:a250983a (explore) - #changes=1
	UPDATE: {StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}
	{StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}: {*unstructured.Unstructured}.Object["status"].(map[string]any)["replicas"].(float64):
	-: 0
	+: 3

	CleanupReconciler:489da49e (explore) - #changes=1
	...
	CleanupReconciler:37dfcf5f (explore) - #changes=1
	...
	CleanupReconciler:5ed37a6f (explore) - #changes=1
