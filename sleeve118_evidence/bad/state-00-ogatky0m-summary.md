...
state keys:
	...
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:51f6d696-6d23-4d90-9e15-3ff5568abbce}
	...
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:bbfd6849-1a2e-441b-b2e3-a41793a1ee04}
	{PersistentVolume//pv-3744934c:c431ef61-eca1-49d6-9c15-1b46ddcd2d7d}
	{Secret/tracey/sleevecdc-superuser:c80a5609-0b61-4740-b270-dc74b71b40d0}
	...
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:fad902f2-20fe-4ce7-855c-1335e9d736a9}
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:51f6d696-6d23-4d90-9e15-3ff5568abbce}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:bbfd6849-1a2e-441b-b2e3-a41793a1ee04}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:fad902f2-20fe-4ce7-855c-1335e9d736a9}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
...
```
Key: {Secret/tracey/sleevecdc-superuser:c80a5609-0b61-4740-b270-dc74b71b40d0}
```
{
  "apiVersion": "v1",
  "data": {
    "password": "aG5qTnZSUzI5ZG9RQUJsTFNfQWp1V01ZdXdLaXowOFNZeF9mamttWDhzNzhGWm9xVmk0cWVn",
...
Path 1:
```
	CassandraDatacenter:85c5d658 (explore) - #changes=1
	...
	StatefulSetController:ec186a63 (explore) - #changes=3
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 9d4af439-0e89-4480-b89e-e19aa9b3ac5d
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: b782ea2a-f220-405c-83eb-9beede528d6c
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 07a6baf7-cb94-4b7d-916a-2316083076a6

	CleanupReconciler:4a65d9dd (explore) - #changes=1
	...
	StatefulSetController:dd2aea28 (explore) - #changes=2
	DELETE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}
	...
	CleanupReconciler:72484f20 (explore) - #changes=1
	REMOVE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:2d631b0f-7b2f-43a2-b547-9ebc070a5fc9}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:2d631b0f-7b2f-43a2-b547-9ebc070a5fc9}: 
	StatefulSetController:2bcab030 (explore) - #changes=1
	DELETE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}: 
	CleanupReconciler:d655ed65 (explore) - #changes=1
	REMOVE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}: 
	StatefulSetController:1592d735 (explore) - #changes=1
	...
	CassandraDatacenter:bebc5254 (explore) - #changes=4
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: a43756d3-6e8f-453c-bf0f-cede48fca485
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 6cc61e5a-ddd4-42c6-b0e4-b2dbeac7b057
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 0922eadf-688d-40f4-9b48-e7fbf8c1b019
...
{*unstructured.Unstructured}.Object["status"].(map[string]any)["superUserUpserted"]:
	...
	CassandraDatacenter:2df246fd (explore) - #changes=2
	CREATE: {Secret/tracey/sleevecdc-superuser:c80a5609-0b61-4740-b270-dc74b71b40d0}
	PATCH: {StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}
	{StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}: {*unstructured.Unstructured}.Object["spec"].(map[string]any)["replicas"].(float64):
	-: 0
	+: 3

	StatefulSetController:3a673d8c (explore) - #changes=3
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:51f6d696-6d23-4d90-9e15-3ff5568abbce}
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:bbfd6849-1a2e-441b-b2e3-a41793a1ee04}
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:fad902f2-20fe-4ce7-855c-1335e9d736a9}
	StatefulSetController:deb206b3 (explore) - #changes=1
	UPDATE: {StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}
	{StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}: {*unstructured.Unstructured}.Object["status"].(map[string]any)["replicas"].(float64):
	-: 0
	+: 3

	CleanupReconciler:959b98bb (explore) - #changes=1
	...
	CleanupReconciler:c2b09389 (explore) - #changes=1
	...
	CleanupReconciler:547f066b (explore) - #changes=1
