...
state keys:
	...
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:2c60feec-59d6-40ca-9f47-922167c458d8}
	...
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:b3f70cfd-fc2c-4121-8bde-411ed8c9eb33}
	{Secret/tracey/sleevecdc-superuser:bef26566-f954-461b-9591-2ff944eacb9c}
	{PersistentVolume//pv-3744934c:c431ef61-eca1-49d6-9c15-1b46ddcd2d7d}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:cf4aa3fc-ed84-479f-8ce4-6559152d8a62}
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:2c60feec-59d6-40ca-9f47-922167c458d8}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:b3f70cfd-fc2c-4121-8bde-411ed8c9eb33}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
...
```
Key: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:cf4aa3fc-ed84-479f-8ce4-6559152d8a62}
```
{
  "apiVersion": "v1",
  "kind": "Pod",
...
```
Key: {Secret/tracey/sleevecdc-superuser:bef26566-f954-461b-9591-2ff944eacb9c}
```
{
  "apiVersion": "v1",
  "data": {
    "password": "S3M5ZVozdXNxekVwMm1yTVM1SWVUYkNHaG5HaldaN2VHa0l3aTk5aXUxRGdVZW9hZHl4MEpB",
...
Path 1:
```
	CassandraDatacenter:2d582106 (explore) - #changes=1
	...
	StatefulSetController:4a0eb1bd (explore) - #changes=3
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: c3b3a7c7-0f04-4b14-ae86-e3f69dfe4d3a
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: a554af3e-19f3-495e-9f1d-1a66d3624d7c
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 6e0718e2-3ac9-4065-ab68-da4aefa81373

	CleanupReconciler:d9c2cc5b (explore) - #changes=1
	...
	StatefulSetController:f05d97f9 (explore) - #changes=2
	DELETE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:2d631b0f-7b2f-43a2-b547-9ebc070a5fc9}
	...
	CleanupReconciler:18f9064f (explore) - #changes=1
	REMOVE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:2d631b0f-7b2f-43a2-b547-9ebc070a5fc9}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:2d631b0f-7b2f-43a2-b547-9ebc070a5fc9}: 
	StatefulSetController:f6ca043e (explore) - #changes=1
	DELETE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}: 
	CleanupReconciler:f9d5571b (explore) - #changes=1
	REMOVE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}
	{Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:6091f9d5-15d1-47f4-802d-191718351a8d}: 
	StatefulSetController:07e67b20 (explore) - #changes=1
	...
	CassandraDatacenter:d047a7b5 (explore) - #changes=4
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: a78164be-d7c1-4c4c-bdfd-0351a339b84f
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: b6307d58-67ab-49ce-9181-240782b33c49
...
{*unstructured.Unstructured}.Object["metadata"].(map[string]any)["labels"].(map[string]any)["discrete.events/deletion-id"]:
	-: <nil>
	+: 964097e7-0c75-47ad-9b82-a21f131b6684
...
{*unstructured.Unstructured}.Object["status"].(map[string]any)["superUserUpserted"]:
	...
	CassandraDatacenter:92ade730 (explore) - #changes=2
	CREATE: {Secret/tracey/sleevecdc-superuser:bef26566-f954-461b-9591-2ff944eacb9c}
	PATCH: {StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}
	{StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}: {*unstructured.Unstructured}.Object["spec"].(map[string]any)["replicas"].(float64):
	-: 0
	+: 3

	StatefulSetController:b1b40633 (explore) - #changes=3
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-0:2c60feec-59d6-40ca-9f47-922167c458d8}
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-1:b3f70cfd-fc2c-4121-8bde-411ed8c9eb33}
	CREATE: {Pod/tracey/sleevecdc-sample-dc-sample-rack-sts-2:cf4aa3fc-ed84-479f-8ce4-6559152d8a62}
	StatefulSetController:7d9e8828 (explore) - #changes=1
	UPDATE: {StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}
	{StatefulSet/tracey/sleevecdc-sample-dc-sample-rack-sts:5f73135d-1f56-45dc-a8b5-838bd26a2e46}: {*unstructured.Unstructured}.Object["status"].(map[string]any)["replicas"].(float64):
	-: 0
	+: 3

	CleanupReconciler:80b9351f (explore) - #changes=1
	...
	CleanupReconciler:e118bb4a (explore) - #changes=1
	...
	CleanupReconciler:4bc281df (explore) - #changes=1
